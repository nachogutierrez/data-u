...
export async function storeData(workloadId, pageSize, pageNumber, payload) {
  await uploadObjectToGCS(pageFilePath(workloadId, pageSize, pageNumber), payload)
}
...
export async function logFailedPage(workloadId, pageSize, pageNumber, payload) {
  await uploadObjectToGCS(pageErrorFilePath(workloadId, pageSize, pageNumber), payload)
}

export async function logFailedItem(workloadId, pageSize, pageNumber, itemNumber, payload) {
  await uploadObjectToGCS(itemErrorFilePath(workloadId, pageSize, pageNumber, itemNumber), payload)
}